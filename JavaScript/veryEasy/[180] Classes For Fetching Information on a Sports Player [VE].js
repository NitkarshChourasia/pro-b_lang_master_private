...
Is a type of function, but instead of using the keyword function to initiate it, we use the keyword class, and the properties are assigned inside a constructor() method.
_________
_________
...
Are string literals allowing embedded expressions. `string text ${expression} string text`.
_________
