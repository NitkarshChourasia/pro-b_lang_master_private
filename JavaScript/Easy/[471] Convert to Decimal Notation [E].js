...
Parses an argument and returns the float value.
_________
_________
Array.prototype.map()
...
So you have a string like: 50%? How about: var percent = "50%"; var result = parseFloat(percent) / 100.0. If you use parseFloat, it will read the string up until the fi …
_________
_________
