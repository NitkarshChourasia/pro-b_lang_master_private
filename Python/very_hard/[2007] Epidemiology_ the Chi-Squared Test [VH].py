...
Given a dictionary data being the table containing the results to analyze ("E" is the Edabitin's row, "T" is the Tutorial's row, with the two columns being the "2 hours passed" and "1/2 hour passed" registered cases, as in the tables above) implement a function that returns an array containing two elements:
___
