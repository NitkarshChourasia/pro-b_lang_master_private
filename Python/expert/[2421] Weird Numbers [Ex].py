...
A number for which the sum of its proper divisors is greater than the number itself. The integer 12 is the first abundant number. Its proper divisors are 1, 2, 3, 4 and …
_________
_________
Weird Number
https://en.wikipedia.org/wiki/Weird_number#:~:text=In%20number%20theory%2C%20a%20weird,sums%20to%20the%20number%20itself.
Also refers to a phenomenon in two's complement arithmetic. In number theory, a weird number is a natural number that is abundant but not semiperfect. In other words, t …
_________
