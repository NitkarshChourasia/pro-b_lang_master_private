...
Create a function that takes two numbers, m and n, being m always negative and n always positive, and returns a list with the Padovan numbers between P(m) and P(n).
