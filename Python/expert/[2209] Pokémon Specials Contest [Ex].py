...
Pokemon Types
https://bulbapedia.bulbagarden.net/wiki/Type
Types are properties for Pokémon and their moves. As of Generation VI, there are 18 types, as listed to the right. Most of these were introduced during Generation I, bu …
_________
