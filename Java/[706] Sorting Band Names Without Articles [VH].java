...
Write a function that sorts the given array of band names discounting the articles "the", "a", "an" if the first word of the band name categorically belongs to.
