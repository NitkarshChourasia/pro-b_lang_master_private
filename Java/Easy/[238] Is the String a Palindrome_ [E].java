...
_________
_________
How to check string for palindrome?
https://stackoverflow.com/questions/4138827/check-string-for-palindrome
A palindrome is a word, phrase, number or other sequence of units that can be read the same way in either direction. To check whether a word is a palindrome I get the …
_________
_________
compareTo() Method
