...
https://byjus.com/maths/perimeter-of-rectangle/
Since the perimeter is equal to the sum of all the sides of the polygon. Hence, in the case of a rectangle, the perimeter (P) is; P = sum of all its four sides P = a …
_________
_________
Rectangle
