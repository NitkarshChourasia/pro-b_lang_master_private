...
Is a java.util.Arrays class method. Arrays.sort() vs Collections.sort(): Arrays.sort works for arrays which can be of primitive data type also. Collections.sort() works …
_________
