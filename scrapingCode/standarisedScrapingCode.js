// you just have to modify the first 5 variables and you can execute the script on any challenge page.
// You don't need to go to even the individual language and difficulty
// program_number is current index number
// current_program_number is the amount of program downloaded in the current difficulty
// current_difficulty is the difficulty you want to start the script
// current_program_difficulty is the latest difficulty of the program
// prog_lang is the language of choice
// I have given the option in comments
// just ahead of the variables.
// rest the script will take care of
// if you are on "Very Easy" you should add +1 int it. for example now you downloaded 52 in javascript and still on very easy then put 53 otherwise put without adding 1 for rest of the difficulties.
// Start with the next index and not the current for example if last program was [600] then write in here 601 (no exception of difficulties)
// Done
// Bye
...
//Final script
var starting_program_index = 53;
var number_of_program_done_in_Cur_dif = 52;
