...
_________
Gapful Number
http://www.numbersaplenty.com/set/gapful_number/
L.Colucci calls a number n of at least 3 digits a gapful number if n is divisible by the number formed by the first and last digit of n. For example, 583 is gapful beca …
_________
