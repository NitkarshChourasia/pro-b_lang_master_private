...
The greatest common divisor of two positive integers a and b is the largest integer which evenly divides both numbers (with no remainder). Euclid, a Greek mathematician …
_________
_________
Euclid's Algorithm
https://en.wikipedia.org/wiki/Greatest_common_divisor#Euclid's_algorithm
A much more efficient method is the Euclidean algorithm, which uses a division algorithm such as long division in combination with the observation that the gcd of two n …
_________
