...
Create a function that takes a number and returns a list of two elements. The first element is the length of the Harshad cluster of which the number is a part. The second is its order in the cluster.
