...
Named after Hero of Alexandria, gives the area of a triangle when the length of all three sides are known. Unlike other triangle area formulae, there is no need to calc …
_________
