"""
####  Pair of Sublists with Max Sum (Casual Version)  ####
...
Is the task of finding a contiguous subarray with the largest sum, within a given one-dimensional array A[1...n] of numbers. Formally, the task is to find indices... …
_________
