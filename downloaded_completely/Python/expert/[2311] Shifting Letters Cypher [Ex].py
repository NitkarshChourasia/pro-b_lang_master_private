...
shift_chars("abcdefghijklmnopqrstuvwxyz", "yywygs", [1, 1, 1, 1, 1, 1]) ➞ "edabit"
...
_________
Shift Ciphers
https://www.codexpedia.com/cryptography/shift-ciphers/
Is one of the earliest and the simplest cryptosystems. A given plaintext is encrypted into a ciphertext by shifting each letter of the given plaintext by n positions.
_________
