...
https://www.splashlearn.com/math-vocabulary/algebra/prime-number#:~:text=In%20math%2C%20prime%20numbers%20are,the%20first%20few%20prime%20numbers.
Are whole numbers greater than 1, that have only two factors – 1 and the number itself. Prime numbers are divisible only by the number 1 or itself. For example, 2, …
_________
