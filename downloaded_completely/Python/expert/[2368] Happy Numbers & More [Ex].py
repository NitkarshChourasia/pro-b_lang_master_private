...
Counts objects arranged in an equilateral triangle (thus triangular numbers are a type of figurate numbers, other examples being square numbers and cube numbers). The n …
_________
_________
Happy Number
https://mathworld.wolfram.com/HappyNumber.html
Let the sum of the squares of the digits of a positive integer be represented by . In a similar way, let the sum of the squares of the digits of be represented by …
_________
_________
Perfect Number
