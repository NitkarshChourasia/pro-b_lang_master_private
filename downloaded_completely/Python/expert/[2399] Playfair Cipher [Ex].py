...
Create a function that takes two strings — a plaintext message or ciphertext txt, and a keyword — and returns the corresponding ciphertext or deciphered plaintext (without spaces and with "x" in odd places as appropriate).
