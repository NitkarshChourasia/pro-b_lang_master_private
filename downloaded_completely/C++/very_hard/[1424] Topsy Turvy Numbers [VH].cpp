...
_________
strobogrammatic
https://www.numbersaplenty.com/set/strobogrammatic_number/
If it remains the same when read upside down a number is strobogrammatic. Usually strobogrammatic numbers are made only of digits $0$, $1$, $6$, $8$, and $9$.
_________
