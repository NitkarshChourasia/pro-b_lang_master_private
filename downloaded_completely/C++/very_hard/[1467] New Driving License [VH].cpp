...
Used for string and character handling.cstring.h is the header file required for string functions and cctype.h is the headerfile required for character functions.
_________
