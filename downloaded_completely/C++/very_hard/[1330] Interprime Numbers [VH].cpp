...
Is a positive integer that can be formed by multiplying two smaller positive integers. Equivalently, it is a positive integer that has at least one divisor other than 1 …
_________
_________
Interprime
https://en.wikipedia.org/wiki/Interprime
Is the average of two consecutive odd primes.[1] For example, 9 is an interprime because it is the average of 7 and 11. The first interprimes are: 4, 6, 9, 12, 15, 18, …
_________
_________
