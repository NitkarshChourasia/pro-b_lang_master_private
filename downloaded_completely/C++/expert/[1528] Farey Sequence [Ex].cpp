...
Is the sequence of completely reduced fractions, either between 0 and 1, or without this restriction,[a] which when in lowest terms have denominators less than or equal …
_________
_________
Farey Sequence
https://mathworld.wolfram.com/FareySequence.html
For any positive integer n is the set of irreducible rational numbers a/b with 0<=a<=b<=n and (a,b)=1 arranged in increasing order. The first few are F_1 = {0/1,1/1} …
_________
