...
I need to create a program that allows a user to input a string and my program will check to see if that string they entered is a palindrome (word that can be read the …
_________
_________
std::reverse
https://www.geeksforgeeks.org/stdreverse-in-c/
Reverses the order of the elements in the range [first, last) of any container.
_________
