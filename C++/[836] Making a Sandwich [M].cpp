...
Given an array of ingredients ingredients and a char flavour flavour as input, create a function that returns the array but with the elements bread around the selected ingredient.
