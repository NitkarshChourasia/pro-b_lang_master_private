...
*) Round up the total resistance to 2 decimal places.
___
...
Resistors are said to be connected together in parallel when both of their terminals are respectively connected to each terminal of the other resistor or resistors. Res …
_________
