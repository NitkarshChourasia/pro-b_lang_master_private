...
Triangles are shapes with three sides. There are different names for the types of triangles. A triangle's type depends on the length of it's sides and the size of it's …
_________
