...
To get the length of a string, use the length() function. You might see some C++ programs that use the size() function to get the length of a string. This is just an a …
_________
