...
Think about how to do it. Is there a function? It is simpler than you think. The numbers and operation will be given as a string, and you should return the value as a string as well.
