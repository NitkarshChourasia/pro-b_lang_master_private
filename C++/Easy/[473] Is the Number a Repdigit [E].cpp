...
Is a natural number composed of repeated instances of the same digit in a positional number system (often implicitly decimal). The word is a portmanteau of repeated and …
_________
_________
Repdigit Numbers
http://oeis.org/wiki/Repdigit_numbers
A (base 10) repdigit number is a number like d, dd, ddd, dddd, ... that contains only (zero or more times) the digit d , with 0 < d < 10 (in its base 10 representa …
_________
_________
