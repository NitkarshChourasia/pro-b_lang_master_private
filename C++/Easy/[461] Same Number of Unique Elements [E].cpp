...
Consider a case where you want to store the marks of the students of a class. But you don't know the number of students in the class and have only an approximate idea a …
_________
_________
