...
Is used to round off the given digit which can be in float or double. It returns the nearest integral value to provided parameter in round function, with halfway cases …
_________
