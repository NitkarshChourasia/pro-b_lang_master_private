...
_________
isdigit()
https://www.geeksforgeeks.org/isdigit-function-in-c-c-with-examples/
Is a function in C that can be used to check if the passed character is a digit or not. It returns a non-zero value if it’s a digit else it returns 0. For example, it r …
_________
