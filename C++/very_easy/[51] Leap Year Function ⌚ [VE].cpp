...
Even though the conversions between year/month/day and the serial date do not need to compute whether or not a year is a leap year, it is still very handy to know wheth …
_________
