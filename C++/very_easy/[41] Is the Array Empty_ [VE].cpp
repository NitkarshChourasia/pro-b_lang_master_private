...
vector::empty
https://www.cplusplus.com/reference/vector/vector/empty/
Test whether vector is empty. Returns whether the vector is empty (i.e. whether its size is 0). This function does not modify the container in any way. To clear the co …
_________
